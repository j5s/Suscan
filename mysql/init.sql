...
CREATE DATABASE IF NOT EXISTS suscan default charset utf8 COLLATE utf8_general_ci;
use suscan;
...
-- ----------------------------
BEGIN;
INSERT INTO `setting` VALUES (1, '1000', '80', '5', 0,'20210823204652', '20210824180554');
COMMIT;
